...
setAttributes(liSpecialLink, { data_image: SpecialMenu.getImage(),
              data_description: SpecialMenu.getDescription() });
...
setAttributes(liContactLink, { data_image: Contact.getImage(),
              data_description: Contact.getDescription() });
